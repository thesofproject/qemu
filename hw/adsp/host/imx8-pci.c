...
//static struct imx8_pci_data pdata = {0, 0, 1, 0};

static uint64_t imx8_pci_read(void *opaque, hwaddr addr,
        unsigned size)
{
...
static void imx8_pci_write(void *opaque, hwaddr addr,
...
const MemoryRegionOps imx8_host_pci_ops = {
    .read = imx8_pci_read,
    .write = imx8_pci_write,
    .endianness = DEVICE_NATIVE_ENDIAN,
};

static void build_acpi_imx8_device(Aml *table)
{
    Aml *crs;
    Aml *method;
...
static void adsp_imx8_write_config(PCIDevice *pci_dev, uint32_t address,
...
void adsp_imx8_pci_realize(PCIDevice *pci_dev, Error **errp)
{
    ...
    pci_dev->config_write = adsp_imx8_write_config;
